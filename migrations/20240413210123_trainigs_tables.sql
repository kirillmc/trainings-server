...
create table exercises_pictures
(
    id   serial primary key,
    exercise_id int not null,
    pictures_id int not null,
    foreign key (exercise_id) references exercises (id) on delete cascade,
    foreign key (pictures_id) references pictures (id) on delete cascade
);

create table exercises_technics
(
...
create table technics_positions
(
    id   serial primary key,
    technic_id int not null,
    position_id int not null,
   foreign key (technic_id) references exercises_technics (technic_id) on delete cascade,
    foreign key (position_id) references positions (id) on delete cascade
);

create table positions_dots
(
    id           serial primary key,
    position_id int not null,
    dot_id int not null,
...
drop table exercises_pictures;
drop table exercises_technics;
drop table technics_positions;
drop table positions_dots;
