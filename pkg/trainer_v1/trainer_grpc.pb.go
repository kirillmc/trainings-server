...
type TrainerV1Client interface {
	...
	SetProgramToClient(ctx context.Context, in *TrainerClientRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	SendRequestToTrainer(ctx context.Context, in *TrainerClientRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	SendRequestToClient(ctx context.Context, in *TrainerClientRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	BlockTrainer(ctx context.Context, in *TrainerClientRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	BlockClient(ctx context.Context, in *TrainerClientRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *trainerV1Client) SetProgramToClient(ctx context.Context, in *TrainerClientRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *trainerV1Client) SendRequestToTrainer(ctx context.Context, in *TrainerClientRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/trainer_v1.TrainerV1/SendRequestToTrainer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *trainerV1Client) SendRequestToClient(ctx context.Context, in *TrainerClientRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/trainer_v1.TrainerV1/SendRequestToClient", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *trainerV1Client) BlockTrainer(ctx context.Context, in *TrainerClientRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *trainerV1Client) BlockClient(ctx context.Context, in *TrainerClientRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type TrainerV1Server interface {
	...
	SetProgramToClient(context.Context, *TrainerClientRequest) (*empty.Empty, error)
	SendRequestToTrainer(context.Context, *TrainerClientRequest) (*empty.Empty, error)
	SendRequestToClient(context.Context, *TrainerClientRequest) (*empty.Empty, error)
	BlockTrainer(context.Context, *TrainerClientRequest) (*empty.Empty, error)
	BlockClient(context.Context, *TrainerClientRequest) (*empty.Empty, error)
...
func (UnimplementedTrainerV1Server) SetProgramToClient(context.Context, *TrainerClientRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetProgramToClient not implemented")
}
func (UnimplementedTrainerV1Server) SendRequestToTrainer(context.Context, *TrainerClientRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendRequestToTrainer not implemented")
}
func (UnimplementedTrainerV1Server) SendRequestToClient(context.Context, *TrainerClientRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendRequestToClient not implemented")
}
func (UnimplementedTrainerV1Server) BlockTrainer(context.Context, *TrainerClientRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BlockTrainer not implemented")
}
func (UnimplementedTrainerV1Server) BlockClient(context.Context, *TrainerClientRequest) (*empty.Empty, error) {
...
func _TrainerV1_SetProgramToClient_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TrainerV1Server).SetProgramToClient(ctx, req.(*TrainerClientRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _TrainerV1_SendRequestToTrainer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TrainerClientRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TrainerV1Server).SendRequestToTrainer(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/trainer_v1.TrainerV1/SendRequestToTrainer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TrainerV1Server).SendRequestToTrainer(ctx, req.(*TrainerClientRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _TrainerV1_SendRequestToClient_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TrainerClientRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TrainerV1Server).SendRequestToClient(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/trainer_v1.TrainerV1/SendRequestToClient",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TrainerV1Server).SendRequestToClient(ctx, req.(*TrainerClientRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _TrainerV1_BlockTrainer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TrainerV1Server).BlockTrainer(ctx, req.(*TrainerClientRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _TrainerV1_BlockClient_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TrainerV1Server).BlockClient(ctx, req.(*TrainerClientRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TrainerV1_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SendRequestToTrainer",
			Handler:    _TrainerV1_SendRequestToTrainer_Handler,
		},
		{
			MethodName: "SendRequestToClient",
			Handler:    _TrainerV1_SendRequestToClient_Handler,
		},
		{
