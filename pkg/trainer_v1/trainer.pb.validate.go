...
// Validate checks the field values on TrainerClientRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *TrainerClientRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on TrainerClientRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// TrainerClientRequestMultiError, or nil if none found.
func (m *TrainerClientRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *TrainerClientRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return TrainerClientRequestMultiError(errors)
	}

	return nil
}

// TrainerClientRequestMultiError is an error wrapping multiple validation
// errors returned by TrainerClientRequest.ValidateAll() if the designated
// constraints aren't met.
type TrainerClientRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m TrainerClientRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m TrainerClientRequestMultiError) AllErrors() []error { return m }

// TrainerClientRequestValidationError is the validation error returned by
// TrainerClientRequest.Validate if the designated constraints aren't met.
type TrainerClientRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e TrainerClientRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e TrainerClientRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e TrainerClientRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e TrainerClientRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e TrainerClientRequestValidationError) ErrorName() string {
	return "TrainerClientRequestValidationError"
}

// Error satisfies the builtin error interface
func (e TrainerClientRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sTrainerClientRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = TrainerClientRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = TrainerClientRequestValidationError{}
