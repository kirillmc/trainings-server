...
func request_TrainerV1_SetProgramToClient_0(ctx context.Context, marshaler runtime.Marshaler, client TrainerV1Client, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq TrainerClientRequest
	var metadata runtime.ServerMetadata
...
func request_TrainerV1_SendRequestToTrainer_0(ctx context.Context, marshaler runtime.Marshaler, client TrainerV1Client, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq TrainerClientRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.SendRequestToTrainer(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_TrainerV1_SendRequestToTrainer_0(ctx context.Context, marshaler runtime.Marshaler, server TrainerV1Server, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq TrainerClientRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.SendRequestToTrainer(ctx, &protoReq)
	return msg, metadata, err

}

func request_TrainerV1_SendRequestToClient_0(ctx context.Context, marshaler runtime.Marshaler, client TrainerV1Client, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq TrainerClientRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.SendRequestToClient(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_TrainerV1_SendRequestToClient_0(ctx context.Context, marshaler runtime.Marshaler, server TrainerV1Server, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq TrainerClientRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.SendRequestToClient(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterTrainerV1HandlerServer(ctx context.Context, mux *runtime.ServeMux, server TrainerV1Server) error {
	...
	mux.Handle("POST", pattern_TrainerV1_SendRequestToTrainer_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/trainer_v1.TrainerV1/SendRequestToTrainer", runtime.WithHTTPPathPattern("/api/request-to-trainer/{trainer_id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_TrainerV1_SendRequestToTrainer_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_TrainerV1_SendRequestToTrainer_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_TrainerV1_SendRequestToClient_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/trainer_v1.TrainerV1/SendRequestToClient", runtime.WithHTTPPathPattern("/api/request-to-client/{trainer_id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_TrainerV1_SendRequestToClient_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_TrainerV1_SendRequestToClient_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("PATCH", pattern_TrainerV1_BlockTrainer_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
	...
	mux.Handle("PATCH", pattern_TrainerV1_BlockClient_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
...
func RegisterTrainerV1HandlerClient(ctx context.Context, mux *runtime.ServeMux, client TrainerV1Client) error {
	...
	mux.Handle("POST", pattern_TrainerV1_SendRequestToTrainer_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/trainer_v1.TrainerV1/SendRequestToTrainer", runtime.WithHTTPPathPattern("/api/request-to-trainer/{trainer_id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_TrainerV1_SendRequestToTrainer_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_TrainerV1_SendRequestToClient_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/trainer_v1.TrainerV1/SendRequestToClient", runtime.WithHTTPPathPattern("/api/request-to-client/{trainer_id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_TrainerV1_SendRequestToClient_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_TrainerV1_SendRequestToTrainer_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"api", "request-to-trainer", "trainer_id"}, ""))

	pattern_TrainerV1_SendRequestToClient_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"api", "request-to-client", "trainer_id"}, ""))
...
var (
	...
	forward_TrainerV1_SendRequestToTrainer_0 = runtime.ForwardResponseMessage

	forward_TrainerV1_SendRequestToClient_0 = runtime.ForwardResponseMessage
